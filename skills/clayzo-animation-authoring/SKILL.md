---
name: clayzo-animation-authoring
description: Author or edit Clayzo animation documents and interactive animated components with the typed authoring package. Use for motion design, product microinteractions, pointer behavior, loops, 2.5D camera work, glass, dithering, custom shaders, previewing, and revision-bound self-review.
---
...
Use `clayzo` commands. Do not use repository-only commands, private APIs, or obsolete package entrypoints.
